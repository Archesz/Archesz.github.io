        ...
        <div className="perfil-skills">
            ...
            <div className="perfil-contatos">
                ...
                <div className="contato-badges">
                    ...
                    <TechIcon url="https://icon-library.com/images/linkedin-icon-white-png/linkedin-icon-white-png-28.jpg" name="Linkedin"/>
                    <TechIcon url="https://icon-library.com/images/instagram-icon-white-png/instagram-icon-white-png-26.jpg" name="Instagram"/>
                    <TechIcon url="https://icon-library.com/images/mail-icon-white/mail-icon-white-12.jpg" name="Gmail"/>
